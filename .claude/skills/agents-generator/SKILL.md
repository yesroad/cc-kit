...
```bash
ls .cursor/ 2>/dev/null && echo "USE_.cursorrules" || \
ls .claude/ 2>/dev/null && echo "USE_AGENTS_OR_CLAUDE" || \
echo "USE_AGENTS.md"
```
...
| 최소 프로젝트 (< 5 파일) | 단일 간결한 AGENTS.md (100줄 미만) |
...
|---|---|
| `/AGENTS.md` | 루트 규칙 파일 |
| `/apps/*/AGENTS.md` | 앱별 규칙 |
| `/packages/*/AGENTS.md` | 패키지별 규칙 |
